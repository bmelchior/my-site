...
export const projects: Project[] = [
  ...
  },
  {
    ...
    sections: {
      ...
      problem:
        "The primary problem is that teams are given access to LLMs, without the context or training needed to make those tools effective. Design teams do a lot of repetitive, high-effort work that follows the same patterns underneath. Writing UX copy that follows voice and tone guidelines. Synthesizing product feedback from multiple sources. Managers referring to the Career Ladder — or improvising — when coaching or advising their team. Each task is important, but the time adds up fast, and the quality varies depending on who does it and how much bandwidth they have that day.",
      solution:
